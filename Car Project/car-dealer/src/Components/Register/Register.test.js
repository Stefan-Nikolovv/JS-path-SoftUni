...
describe("Test Register Page", () => {
  ...
  test("Email is invalid format", async () => {
    ...
    await waitFor(() =>
      expect(errorMessage.textContent).toBe("This is not a valid email format!")
    );
  });
  ...
  test("Repeat password is empty string", async () => {
    ...
    await waitFor(() =>
      expect(errorMessage.textContent).toBe("RePassword is required!")
    );
  });
  ...
  test("Repeat password missmatch ", async () => {
    ...
    await waitFor(() =>
      expect(errorMessage.textContent).toBe("Passwords missmatch!")
    );
  });
  ...
  test("Register User trying to register again", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId("reRgisterError").textContent).toBe(
